    ...
    "SIDEBAR": {
        ...
        "navigation": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"title": "Worker profiles", "icon": "badge", "link": _changelist("profiles_workerprofile"),
                     "badge": "apps.core.admin_badges.publish_reviews", "badge_variant": "warning"},
                    {"title": "ID verifications", "icon": "verified_user",
                     "link": _changelist("profiles_idverification"),
                     "badge": "apps.core.admin_badges.id_verifications", "badge_variant": "danger"},
            ...
            },
            {
                ...
                "items": [
                    {"title": "Jobs", "icon": "work", "link": _changelist("jobs_job"),
                     "badge": "apps.core.admin_badges.jobs", "badge_variant": "warning"},
                    ...
                    {"title": "Services", "icon": "store", "link": _changelist("gigs_service"),
                     "badge": "apps.core.admin_badges.services", "badge_variant": "warning"},
                    {"title": "Buying requests", "icon": "shopping_cart", "link": _changelist("gigs_buyingrequest"),
                     "badge": "apps.core.admin_badges.buying_requests", "badge_variant": "warning"},
            ...
            },
            {
                ...
                "items": [
                    {"title": "Contracts", "icon": "handshake", "link": _changelist("contracts_contract"),
                     "badge": "apps.core.admin_badges.disputes", "badge_variant": "danger"},
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"title": "Withdrawals", "icon": "payments", "link": _changelist("payments_withdrawalrequest"),
                     "badge": "apps.core.admin_badges.withdrawals", "badge_variant": "danger"},
            ...
            },
            {
                ...
                "collapsible": True,
                "items": [
                    {"title": "Chat inbox", "icon": "chat_bubble", "link": reverse_lazy("admin:chat_inbox")},
                    ...
                    {"title": "Chat reports", "icon": "flag", "link": _changelist("chat_chatreport"),
                     "badge": "apps.core.admin_badges.chat_reports", "badge_variant": "danger"},
                    {"title": "Content reports", "icon": "report", "link": _changelist("core_report"),
                     "badge": "apps.core.admin_badges.content_reports", "badge_variant": "danger"},
                    ...
                    {"title": "Broadcasts", "icon": "campaign", "link": _changelist("notifications_schedulednotification"),
                     "badge": "apps.core.admin_badges.broadcasts", "badge_variant": "info"},
                    ...
                    {"title": "Tickets", "icon": "support_agent", "link": _changelist("tickets_ticket"),
                     "badge": "apps.core.admin_badges.tickets", "badge_variant": "warning"},
